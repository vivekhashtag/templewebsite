...
export default function ContactUsPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    window.location.href = `mailto:tiruvadisoolam@gmail.com?subject=Contact%20Form%20Submission&body=Name:%20${formData.name}%0AEmail:%20${formData.email}%0APhone:%20${formData.phone}%0AMessage:%20${formData.message}`;
  };
